...
<div class="container mt-2">
    ...
    <?php 
        ...
        if(mysqli_num_rows($product) > 0)
        {
            ...
            <input type="file" name="imageMain" value="<?= $data['imageMain']?>" class="form-control" required>
            </div>
                <div class="col-md-4"> 
            ...
            <input type="file" name="thumbnail_1" value="<?= $data['thumbnail_1']?>" class="form-control" required>
            </div>
                <div class="col-md-4"> 
            ...
            <input type="file" name="thumbnail_2" value="<?= $data['thumbnail_2']?>" class="form-control" required>
            </div>
                <div class="col-md-4"> 
            ...
            <input type="file" name="thumbnail_3" value="<?= $data['thumbnail_3']?>" class="form-control" required>
            </div>
                <div class="col-md-12"> 
